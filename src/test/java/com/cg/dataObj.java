...
public class dataObj extends Base {

	@DataProvider
	public Object[][] getdata(int i, int j) throws IOException {
		return TestUtil.readExcelData("C:\\Users\\admin\\eclipse-workspace\\ExcelProject\\ExcelFolder\\Book2.xlsx",
				"Test");
